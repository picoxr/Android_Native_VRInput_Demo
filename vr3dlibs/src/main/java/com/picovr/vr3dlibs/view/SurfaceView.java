package com.picovr.vr3dlibs.view;
...
import com.picovr.vr3dlibs.renderer.ISurfaceRenderer;
import com.picovr.vr3dlibs.util.Capabilities;
import com.picovr.vr3dlibs.util.egl.RajawaliEGLConfigChooser;
...
public class SurfaceView extends GLSurfaceView implements ISurface {
    ...
    /**
     * Delegate used to translate between {@link Renderer} and {@link ISurfaceRenderer}.
     *
     * @author Jared Woolston (jwoolston@tenkiv.com)
     */
