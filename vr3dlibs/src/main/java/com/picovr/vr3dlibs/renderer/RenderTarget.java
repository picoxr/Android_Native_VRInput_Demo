...
public class RenderTarget {
	...
	public RenderTarget(String name, int width, int height, int offsetX, int offsetY,
			...
			int glType, Config bitmapConfig, ATexture.FilterType filterType,
			ATexture.WrapType wrapType) {
		mName = name;
		mWidth = width;
		mHeight = height;
		mOffsetX = offsetX;
	...
	public RenderTarget(String name, int width, int height) {
		this(name, width, height, 0, 0, false, false, GLES20.GL_TEXTURE_2D, Config.ARGB_8888, ATexture.FilterType.LINEAR,
				ATexture.WrapType.CLAMP);
	}
