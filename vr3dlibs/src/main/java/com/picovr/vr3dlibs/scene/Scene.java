 ...
 */
package com.picovr.vr3dlibs.scene;
...
import com.picovr.vr3dlibs.animation.Animation;
...
import com.picovr.vr3dlibs.materials.plugins.FogMaterialPlugin;
import com.picovr.vr3dlibs.materials.plugins.ShadowMapMaterialPlugin;
...
import com.picovr.vr3dlibs.primitives.Cube;
import com.picovr.vr3dlibs.renderer.AFrameTask;
import com.picovr.vr3dlibs.renderer.RenderTarget;
import com.picovr.vr3dlibs.renderer.Renderer;
import com.picovr.vr3dlibs.renderer.plugins.IRendererPlugin;
import com.picovr.vr3dlibs.renderer.plugins.Plugin;
import com.picovr.vr3dlibs.scenegraph.IGraphNode;
import com.picovr.vr3dlibs.scenegraph.Octree;
import com.picovr.vr3dlibs.util.ObjectColorPicker;
import com.picovr.vr3dlibs.util.RajLog;
import com.picovr.vr3dlibs.view.ISurface;
...
public class Scene {
	...
	*/
	...
	protected IGraphNode.GRAPH_TYPE mSceneGraphType = IGraphNode.GRAPH_TYPE.NONE; //The type of graph type for this scene.
