...
import com.picovr.vr3dlibs.loader.awd.exceptions.NotParsableException;
import com.picovr.vr3dlibs.materials.Material;
import com.picovr.vr3dlibs.materials.methods.DiffuseMethod;
import com.picovr.vr3dlibs.materials.methods.SpecularMethod;
import com.picovr.vr3dlibs.materials.textures.NormalMapTexture;
import com.picovr.vr3dlibs.materials.textures.SpecularMapTexture;
...
public class BlockSimpleMaterial extends ATextureBlockParser {
	...
	static {
		...
		EXPECTED_PROPS.put(PROP_COLOR, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_UINT32);
		EXPECTED_PROPS.put(PROP_TEXTURE, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BADDR);
		EXPECTED_PROPS.put(PROP_NORMAL_TEXTURE, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BADDR);
		EXPECTED_PROPS.put(PROP_SPEZIAL_ID, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_UINT8);
		EXPECTED_PROPS.put(PROP_SMOOTH, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BOOL);
		EXPECTED_PROPS.put(PROP_MIPMAP, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BOOL);
		EXPECTED_PROPS.put(PROP_BOTH_SIDES, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BOOL);
		EXPECTED_PROPS.put(PROP_PRE_MULTIPLIED, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BOOL);
		EXPECTED_PROPS.put(PROP_BLEND_MODE, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_UINT8);
		EXPECTED_PROPS.put(PROP_ALPHA, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_NR);
		EXPECTED_PROPS.put(PROP_ALPHA_BLENDING, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BOOL);
		EXPECTED_PROPS.put(PROP_BINARY_ALPHA_THRESHOLD, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_NR);
		EXPECTED_PROPS.put(PROP_REPEAT, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BOOL);
		EXPECTED_PROPS.put(PROP_DIFFUSE_LEVEL, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_NR);
		EXPECTED_PROPS.put(PROP_AMBIENT_LEVEL, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_NR);
		EXPECTED_PROPS.put(PROP_AMBIENT_COLOR, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_UINT32);
		EXPECTED_PROPS.put(PROP_AMBIENT_TEXTURE, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BADDR);
		EXPECTED_PROPS.put(PROP_SPECULAR_LEVEL, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_NR);
		EXPECTED_PROPS.put(PROP_SPECULAR_GLOSS, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_NR);
		EXPECTED_PROPS.put(PROP_SPECULAR_COLOR, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_UINT32);
		EXPECTED_PROPS.put(PROP_SPECULAR_TEXTURE, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BADDR);
		EXPECTED_PROPS.put(PROP_LIGHT_PICKER, LoaderAWD.AWDLittleEndianDataInputStream.TYPE_BADDR);
	}
	...
	{
		final LoaderAWD.BlockHeader lookupHeader = blockHeader.blockHeaders.get((short) texref);
