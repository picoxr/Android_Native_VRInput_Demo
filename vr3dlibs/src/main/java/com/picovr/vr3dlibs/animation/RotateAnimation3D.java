...
public class RotateAnimation3D extends Animation3D {
	...
	public RotateAnimation3D(double xRotate, double yRotate, double zRotate) {
		...
		mQuat.multiply(new Quaternion().fromAngleAxis(Vector3.getAxisVector(Vector3.Axis.Y), yRotate));
		mQuat.multiply(new Quaternion().fromAngleAxis(Vector3.getAxisVector(Vector3.Axis.Z), zRotate));
		mQuat.multiply(new Quaternion().fromAngleAxis(Vector3.getAxisVector(Vector3.Axis.X), xRotate));
	}
