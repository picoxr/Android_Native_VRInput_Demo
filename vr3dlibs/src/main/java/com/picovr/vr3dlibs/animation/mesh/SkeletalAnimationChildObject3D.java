 ...
 */
package com.picovr.vr3dlibs.animation.mesh;

import android.opengl.GLES20;

import com.picovr.vr3dlibs.BufferInfo;
import com.picovr.vr3dlibs.Geometry3D;
...
public class SkeletalAnimationChildObject3D extends AAnimationObject3D {
	...
	public void setSkeletonMeshData(int numVertices, BoneVertex[] vertices, int numWeights, BoneWeight[] weights) {
		...
		mGeometry.addBuffer(mboneIndexes1BufferInfo, Geometry3D.BufferType.FLOAT_BUFFER, GLES20.GL_ARRAY_BUFFER);
		mGeometry.addBuffer(mboneWeights1BufferInfo, Geometry3D.BufferType.FLOAT_BUFFER, GLES20.GL_ARRAY_BUFFER);
		if (mMaxBoneWeightsPerVertex > 4) {
			...
			mGeometry.addBuffer(mboneIndexes2BufferInfo, Geometry3D.BufferType.FLOAT_BUFFER, GLES20.GL_ARRAY_BUFFER);
			mGeometry.addBuffer(mboneWeights2BufferInfo, Geometry3D.BufferType.FLOAT_BUFFER, GLES20.GL_ARRAY_BUFFER);
		}
	}
