...
public class SkeletalAnimationObject3D extends AAnimationObject3D {
	...
	public SkeletalAnimationObject3D() {
		mTmpJoint1 = new SkeletalAnimationFrame.SkeletonJoint();
		mTmpJoint2 = new SkeletalAnimationFrame.SkeletonJoint();
	}
	...
	public void setJoints(SkeletalAnimationFrame.SkeletonJoint[] joints) {
		...
		mGeometry.addBuffer(mBoneMatricesBufferInfo, Geometry3D.BufferType.FLOAT_BUFFER, GLES20.GL_ARRAY_BUFFER);
	}
	...
	public void setShaderParams(Camera camera) {
		...
		for (int i = 0; i < mJoints.length; ++i) {
			SkeletalAnimationFrame.SkeletonJoint joint = getJoint(i);
