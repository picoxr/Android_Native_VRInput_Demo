...
import com.picovr.vr3dlibs.materials.shaders.fragments.diffuse.LambertFragmentShaderFragment;
import com.picovr.vr3dlibs.materials.shaders.fragments.diffuse.LambertVertexShaderFragment;
import com.picovr.vr3dlibs.materials.shaders.fragments.effects.ToonFragmentShaderFragment;
...
public abstract class DiffuseMethod {
	...
	public static enum DiffuseShaderVar implements AShaderBase.IGlobalShaderVar {
		...
		DiffuseShaderVar(String varString, AShaderBase.DataType dataType) {
