 ...
 */
package com.picovr.vr3dlibs.materials.shaders;

import android.graphics.Color;
import android.opengl.GLES20;

import com.picovr.vr3dlibs.lights.ALight;
import com.picovr.vr3dlibs.materials.Material.PluginInsertLocation;
...
public class VertexShader extends AShader {
    ...
    public void main() {
        ...
        if (hasSkeletalAnimation) {
            RMat4 transfMatrix = (RMat4) getGlobal(SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.G_BONE_TRANSF_MATRIX);
