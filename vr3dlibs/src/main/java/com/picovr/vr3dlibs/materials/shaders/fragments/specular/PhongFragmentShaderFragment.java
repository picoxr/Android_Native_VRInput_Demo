 ...
 */
package com.picovr.vr3dlibs.materials.shaders.fragments.specular;
...
import com.picovr.vr3dlibs.materials.shaders.fragments.texture.ATextureFragmentShaderFragment;
...
public class PhongFragmentShaderFragment extends ATextureFragmentShaderFragment implements IShaderFragment {
	...
	public void main() {
		...
		for(int i=0; i<mLights.size(); ++i) {
			...
			RFloat nDotL = (RFloat)getGlobal(DiffuseMethod.DiffuseShaderVar.L_NDOTL, i);
	...
	public void initialize()
	{
		...
		muSpecularColor = (RVec3) addUniform(SpecularMethod.SpecularShaderVar.U_SPECULAR_COLOR);
		muShininess = (RFloat) addUniform(SpecularMethod.SpecularShaderVar.U_SHININESS);
		muSpecularIntensity = (RFloat) addUniform(SpecularMethod.SpecularShaderVar.U_SPECULAR_INTENSITY);
	}
	
	@Override
	public void setLocations(int programHandle) {
		super.setLocations(programHandle);
		muSpecularColorHandle = getUniformLocation(programHandle, SpecularMethod.SpecularShaderVar.U_SPECULAR_COLOR);
		muShininessHandle = getUniformLocation(programHandle, SpecularMethod.SpecularShaderVar.U_SHININESS);
		muSpecularIntensityHandle = getUniformLocation(programHandle, SpecularMethod.SpecularShaderVar.U_SPECULAR_INTENSITY);
	}
