 ...
 */
package com.picovr.vr3dlibs.materials.shaders.fragments.animation;
...
import com.picovr.vr3dlibs.util.ArrayUtils;
...
public class SkeletalAnimationVertexShaderFragment extends AShader implements IShaderFragment {
	...
	public void initialize()
	{
		...
		mgBoneTransfMatrix = (RMat4) addGlobal(SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.G_BONE_TRANSF_MATRIX);
		
		muBoneMatrix = (RMat4) addUniform(SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.U_BONE_MATRIX);
		muBoneMatrix.isArray(mNumJoints);
		
		maBoneIndex1 = (RVec4) addAttribute(SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_INDEX1);
		maBoneWeight1 = (RVec4) addAttribute(SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_WEIGHT1);
		if(mVertexWeight > 4)
		{
			maBoneIndex2 = (RVec4) addAttribute(SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_INDEX2);
			maBoneWeight2 = (RVec4) addAttribute(SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_WEIGHT2);
		}
	}
	...
	public void setLocations(final int programHandle) {
		muBoneMatrixHandle = getUniformLocation(programHandle, SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.U_BONE_MATRIX);
		
		maBoneIndex1Handle = getAttribLocation(programHandle, SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_INDEX1);
		maBoneWeight1Handle = getAttribLocation(programHandle, SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_WEIGHT1);
		if(mVertexWeight > 4)
		{
			maBoneIndex2Handle = getAttribLocation(programHandle, SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_INDEX2);
			maBoneWeight2Handle = getAttribLocation(programHandle, SkeletalAnimationMaterialPlugin.SkeletalAnimationShaderVar.A_BONE_WEIGHT2);
		}
	}
