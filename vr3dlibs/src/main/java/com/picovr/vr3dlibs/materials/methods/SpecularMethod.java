...
import com.picovr.vr3dlibs.materials.shaders.fragments.specular.PhongFragmentShaderFragment;
...
public abstract class SpecularMethod {
	...
	public static enum SpecularShaderVar implements AShaderBase.IGlobalShaderVar {
		...
		SpecularShaderVar(String varString, AShaderBase.DataType dataType) {
