...
import com.picovr.vr3dlibs.materials.plugins.VertexAnimationMaterialPlugin;
...
public class VertexAnimationVertexShaderFragment extends AShader implements IShaderFragment {
	...
	public void initialize()
	{
		...
		maNextFramePosition = (RVec4) addAttribute(VertexAnimationMaterialPlugin.VertexAnimationShaderVar.A_NEXT_FRAME_POSITION);
		maNextFrameNormal = (RVec3) addAttribute(VertexAnimationMaterialPlugin.VertexAnimationShaderVar.A_NEXT_FRAME_NORMAL);
		muInterpolation = (RFloat) addUniform(VertexAnimationMaterialPlugin.VertexAnimationShaderVar.U_INTERPOLATION);
	}
	...
	public void setLocations(final int programHandle) {
		maNextFramePositionHandle = getAttribLocation(programHandle, VertexAnimationMaterialPlugin.VertexAnimationShaderVar.A_NEXT_FRAME_POSITION);
		maNextFrameNormalHandle = getAttribLocation(programHandle, VertexAnimationMaterialPlugin.VertexAnimationShaderVar.A_NEXT_FRAME_NORMAL);
		muInterpolationHandle = getUniformLocation(programHandle, VertexAnimationMaterialPlugin.VertexAnimationShaderVar.U_INTERPOLATION);
	}
